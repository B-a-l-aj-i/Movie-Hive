...
<div className="flex items-center gap-6 max-sm:flex-col-reverse max-sm:gap-0  max-sm:justify-between">
        ...
        <p className="flex gap-3 text-white text-x  max-sm:pt-2 pt-4 font-semibold " >Anonymous
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-7 max-sm:size-6 text-yellow-600 ">
